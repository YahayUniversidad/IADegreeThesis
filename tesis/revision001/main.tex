...
\fancyfoot[L]{\footnotesize Master in Artificial Intelligence} %left
...
\end{figure}
        ...
        \vspace*{1.75cm}
        %{\mymaintitlesize{\textbf{Improving Ad Hoc Network Performance in Disaster Scenarios with Machine Learning}}\\
        {\mymaintitlesize{\textbf{TITULO}}\\ \vspace*{0.75cm} Sistema Integrado de Inteligencia de Negocio para la Predicción de Crisis Crediticias mediante las técnicas de análisis de Inteligencia artificial y de negocio}\\
        \vspace*{1.75cm}
