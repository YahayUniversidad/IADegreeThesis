...
La variable binaria \texttt{crisis\_flag} se construye mediante ocho condiciones heurísticas o llamados criterios empíricos con pesos acumulativos. Si la suma de pesos supera el umbral de 5, el bloque se etiqueta como crisis (1); de lo contrario, como no crisis (0). Las ocho condiciones son:
