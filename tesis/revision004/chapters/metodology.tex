...
La arquitectura integra cinco componentes: PostgreSQL 15 como repositorio operativo y analítico; Apache Airflow 2.10 como orquestador; Python 3.12 y Notebook Jupyter para el desarrollo de modelos; MLflow para el registro de experimentos; y Apache Superset para la visualización. La Figura 4.1 resume las interacciones entre estos componentes.
...
La Tabla 4.3 documenta la trazabilidad de los datos desde las fuentes hasta las muestras de entrenamiento, extraída del análisis del código fuente.
...
El proyecto calcula veintiuna características numéricas derivadas de las tres fuentes. La Tabla 4.4 presenta el diccionario completo extraído del código fuente.
...
\begin{table}[H]
    ...
    \hline
    \end{tabular}
    \caption{Recursos computacionales y versiones de software. Corresponde a un pc de uso doméstico}
    \label{tab:recursos}
\end{table}
