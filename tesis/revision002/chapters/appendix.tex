...
Contenedores Docker: \url{https://github.com/YahayUniversidad/IADegreeThesis/tree/main/Contenedores}

Desarrollo de la solución: \url{https://github.com/YahayUniversidad/IADegreeThesis/tree/main/Desarrollo}

Documentación relacionada: \url{https://github.com/YahayUniversidad/IADegreeThesis/tree/main/DocumentosBase}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{images/MM-08a Estrella para fact_creditos_mensual.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{images/MM-8b Estrella para fact_predicciones.png}
