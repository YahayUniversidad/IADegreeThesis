...
\begin{figure}[H]
    ...
    \caption{Arquitectura general del prototipo. Las tres fuentes se integran mediante ETL, se almacenan en PostgreSQL, se entrenan tres modelos registrados en MLflow, y los resultados se visualizan en Apache Superset.}
