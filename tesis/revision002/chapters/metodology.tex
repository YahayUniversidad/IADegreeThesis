Este capítulo describe el diseño de la investigación, la arquitectura del prototipo, la preparación de datos, los modelos y el protocolo de evaluación. Los resultados numéricos y su interpretación se presentan exclusivamente en el Capítulo 5.
